...
```sh
  cd my-folder
  git clone git@github.com:Braingenius2/Leaderboard.git
```
...
### Usage
"Leaderboard" is a simple website that displays a list of of top scores of users and allows you to add and update the scorecard.
